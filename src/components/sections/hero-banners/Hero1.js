...
const CSS = `
  ...
  .hs-bowl-wrap {
    ...
    width: clamp(320px, 35vw, 500px); height: clamp(320px, 35vw, 500px);
    overflow: visible;
  }
                ...
                <div className="hs-bowl-wrap">
                  {cupAnimating && prevCup !== null && (
                    <div className={`hs-bowl-item ${cupOutAnim}`}
                      ...
                      <Image src={SLIDES[prevCup].mainImg} alt="" fill sizes="493px" style={{ objectFit: "contain" }} />
                    </div>
                  )}
                  <div key={`cup-in-${animKey}-${current}`} className={`hs-bowl-item ${cupAnimating ? cupInAnim : ""}`}>
                    <Image src={slide.mainImg} alt={`${slide.line1} ${slide.line2}`} fill sizes="493px"
